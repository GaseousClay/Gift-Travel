...
Following Alduncin, Parker, and Theriault [-@Alduncin2017], we run the analyses separately for the two parties under the assumption that the explanatory variables may operate differently within each party. We do include whole-chamber analyses for comparison.
