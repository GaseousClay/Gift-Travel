...
At the end of May 2013, ten members of Congress, along with thirty-two members of their staff and dozens of state legislators, traveled to the Baku, Azerbaijan, on the shore of the Caspian Sea, to take part in an all-expense-paid conference and cultural visit. They listened to speeches given by the president of Azerbaijan, three former advisors to President Obama; they heard briefings from the chairs of the Azerbaijani Parliament's foreign affairs and armed services committees, as well as at least three briefings pertaining to the country's state-owned oil company. U.S. representatives, many of whom brought along their spouses, also partook in local festivities, such as a fireworks show for the Republic Day of Azerbaijan, and a tour of the Old City. 

The trip sparked controversy when it was reported that the Azerbaijan-affiliated nonprofits that sponsored the travel had used money that originated from the state-owned oil company that had held information sessions during the conference [@Tucker2014]. While it is legal for nongovernmental organziations to pay for members to go on such excursions, it is forbidden for members to accept travel offers from foreign countries or corporations that employ U.S. lobbyists, as well as meet with lobbyists at any time during their travel [@Wickham2015]. As per House rules, the members had all received approval from the House Ethics Committee before going to Baku, but, while they may not have know it, they were accepting illicit gifts from a foreign government; and upon their return to the United States, they were obligated to report if there had been any foreign or corporate sponsorship, which a report conducted by the Office of Congressional Ethics found that they had failed to do [@Tucker2014]. The *Washington Post* speculated that the trip, and the courtship of which it was a part, may have played a role in a few of members' decisions to sponsor amendments that exempted an Azerbaijani pipeline project from a sanctions bill that was under consideration at the time [@Choma2015; @Higham2015].

The Office of Congressional Ethics ultimately recommended to the House Ethics Committee that the investigation into nine members who violated House code and federal law be further reviewed, and it was handed off to the Department of Justice [@OCE2015]. Interestingly, the OCE's report, though not its findings of fact, was release by the Ethics Committee. This episode highlights the potential for NGO-sponsored travel to be gamed by the sponsors, the laxness of the self-reporting system, and the difficulty in connecting what goes on during these trips with legislators' preferences and behavior. It should be noted that while this particular trip was unusual because it was found to have broken House rules and maybe federal law (e.g., the Emoluments Clause), in many other ways it was an ordinary instance of gift travel. Members were invited by a nonprofit to listen to speeches in and tour around a foreign country. Though the conference halls were festooned with corporate logos, such as BP's, the members found nothing suspicious about the event's proceedings [@Luxner2013]. The speeches and briefings and mingling were all a part of what a member typically experiences on a NGO-sponsored trip.

As the Baku episode illustrates, members of Congress and interest groups have a dynamic relationship. They are locked in a continuous dance in which either side influences the other in order to pursue its political goals. They are engaged in a mutually beneficial give-and-take, though the American public is always suspicious about the potential for corruption between these groups and their representatives.

Suspicious of these relationships too, political scientists have investigated how interest groups, corporations, and think tanks--and their respective Political Action Committees--attempt to influence policymakers. The empirical evidence with regard to exogenous actors directly "buying" members votes has not found much of a relationship [@Welch1982; @Wright1990]. However, contributions that are timed correctly, such as before critical votes, have given scholars pause [@Stratmann1998]. And, certain groups seem to invest in members long-term [@Snyder1992].

A more nuanced type of influence is more likely. Hall and Wayman [-@Hall1990] argue that contributions lead to less measurable changes, like shifts in the content of bills. It is also possible that interest groups provide critical information or services that make the lives of already overwhelmed legislators easier [@Hall2006]. Langbein [-@Langbein1986] argues that money buys access to members of Congress and estimates that a PAC would need to contribute approximately $72,000 for one hour with a member.

We argue, similar to the money buys access theory, that interest groups provide members with *gift travel* as an attempt to buy access and influence their policy preferences. Gift travel occurs when a member, or one of her staff, goes on an expense-paid trip sponsored by a non-governmental organization, such as a trade association, think tank, cable channel, or university. When members go on these sponsored trips, they must report it to the Clerk of the House[^1]. Gift travel represents an important, but understudied, example of representative behavior. Learning about gift travel behavior informs us about how members spend their time and resources on an unseen realm of information exchange sponsored by groups seeking influence in the policy process. We also potentially have much to learn about the relationships that members and interest groups cultivate through these expense-paid trips.

[^1]: According to Rule XXV, clause 5 of the Rules of the House of Representatives, members must disclose reimbursement for such travel within 15 days of return [@Wickham2015]. The Clerk of the House makes a report of these disclosures public on its website. Rule XXV is also clear that no such gift travel can be paid for by a registered lobbyist or by the agent of a foreign principal, and neither can a registered lobbyist or agent of a foreign principal be present at any time during the trip[^2].

[^2]: There are a few exceptions where members of Congress may have their travel paid for by foreign governments. These exceptions are usually when foreign governments pay for in-country expenses or travel for members visiting the sponsoring country. There are limitations for how long these foreign-government-paid trips may be, and oftentimes these trips must be pre-approved by the relevant committee.

Study of when and where members of Congress travel is not new. For instance, scholars have investigated where, how often, for how long, and with whom, members travel abroad as part of Congressional Delegations, or CODELs in Capitol parlance (see for example [@Alduncin2014; @Alduncin2017]). When they want to travel as part of a Congressional Delegation, members must first request permission and funding from the parent chamber or relevant committee. Members can also be asked by other members if they would like to participate in a delegation trip. Some CODELs are partisan, others are bipartisan, but they are usually conducted in groups, presumably for the purpose of learning something valuable to their jobs as legislators, though some members have been criticized by challengers for wasting taxpayer money on pleasure trips.

Gift travel must also be for the purpose of official business. Members are not supposed to accept reimbursement for trips conducted primarily for leisure or diversion; such trips, of course, would give the appearance of corruption. Gift travel allows non-governmental organizations, such as trade associations, non-profits, think tanks, and universities to invite members of Congress to conferences, conventions, dinners, and other types of events. But why do non-governmental organizations choose to fly members to their events? Are some members more likely to be invited than others, and if so, why? Ultimately, we would like to ask, what effect does gift travel have on members' legislative behavior?

However, we still lack answers to basic questions such as "how much gift travel do members go on?" and "what organizations are the most popular sponsors" are unanswered in the literature on members' travel behavior. This paper provides a first look at this specific kind of travel behavior while also attempting to understand the dynamics between these members and the interest groups sponsoring their trips. We will rely on the literature on foreign travel among members of Congress to inform our hypotheses about gift travel since foreign travel is the nearest thing to gift travel that scholars have studied. The key difference to keep in mind is that delegation and committee travel are the product of members' initiative while gift travel starts, at least in theory, with the giver.

We theorize that sponsoring organizations are seeking short-term policy influence, information exchance, and the opportunity to have the member's time. Therefore we hypothesize that groups target members who are strategically positioned to influence policy. We expect high-ranking, safe, and senior members to travel more, and ideologically extreme members to travel less. We find that party leaders, committee chairs, and ranking members travel much more than the rank and file, but that seniority and safety have nonsignificant and small effects, respectively. Unexpectedly, greater ideological extremeness is associated with more gift travel rather than less.
...
The data for this analysis come from the website of the Clerk of the House. The Clerk has published yearly, since 2007, when House rules changed and this system of reporting began, all of the gift travel reports that representatives file [@Dent2015, 11]. This paper analyzes these reports from the 110th through the 114th Congresses (2007-2017). These data, after cleaning, collapsing duplicate trip entries, and aggregating by member, consist of 2180 observations, which are at the level of the member per Congress.[^3]

[^3]: Interestingly, almost half of the original entries were duplicates. For example, one of Speaker Boehner's trips to Jacksonville, Florida had 18 separate but identical filings in the 114th Congress' reports. Why this occurs is unclear.
...
ggplot(data = giftdata, aes(x=trips)) + geom_histogram(bins = 30, color="darkblue", fill="lightblue") + theme_classic() + ggtitle("Figure 1: Histogram of Gift-Travel Trips")
```
...
*Chair* indicates whether the member was the chair of a committee. 

Its converse is *committee*, which includes those who were ranking members on their committees. 
...
Following Alduncin, Parker, and Theriault [-@Alduncin2017], we run the analyses separately for the two parties under the assumption that the explanatory variables may operate differently within each party. However, we also include whole-chamber analyses for comparison.

```{r, echo = F, include = F}
library(ggplot2)
giftdata <- read.csv(file = "110-114Congresses.csv", header = TRUE, stringsAsFactors = FALSE)
ggplot(data = giftdata, aes(x = trips, color = as.factor(party))) + geom_histogram(bins = 15, fill="white", alpha=0.5, position="dodge") + theme_classic() + ggtitle("Figure 2: Histogram of Trips by Party (Red = Democrat)")
```
